...
extern fn file_is_empty(path: str) -> bool
extern fn file_is_dir(path: str) -> bool
extern fn file_size(path: str) -> usize
extern fn file_modified_time(path: str) -> usize
extern fn file_accessed_time(path: str) -> usize
extern fn file_created_time(path: str) -> usize
...
extern fn truncate_file(path: str, size: usize) -> int
...
extern fn dir_exists(path: str) -> bool
