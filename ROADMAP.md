...
- Direct `std.mem.alloc`/`free`/`realloc` lifetime is covered by Linux execution and Windows PE64 compilation fixtures; allocation-backed string/file helpers and `alloc_copy` still need unified lifetime headers.
