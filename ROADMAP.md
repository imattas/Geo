...
Both compiler-owned object writers now preserve full signed 64-bit integer
constants, and their scalarized aggregate ABI paths are covered by object
emission tests as well as direct executable tests.
