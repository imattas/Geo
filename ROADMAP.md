...
- Direct `std.mem.alloc`/`free`/`realloc`/`alloc_copy` lifetime is covered by Linux execution and Windows PE64 compilation fixtures; allocation-backed string/file helpers still need unified lifetime headers.
