...
- direct PE64 executable emission for no-console-output Windows programs now wraps compiled Win64 machine code for `main` and internal calls before calling `ExitProcess`
