...
- direct PE64 executable emission for no-console-output Windows programs now wraps compiled Win64 machine code for `main`, internal calls, `.rdata` references, and bounds-check calls before calling `ExitProcess`
