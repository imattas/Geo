...
The PE64 path now also emits `std.io.write_file`, `std.io.append_file`, `std.io.touch_file`, and `std.io.remove_file` directly through compiler-owned Win32 calls; handle-based file operations remain open.
