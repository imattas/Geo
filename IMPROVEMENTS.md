...
The PE64 path now also emits `std.io.write_file`, `std.io.append_file`, `std.io.touch_file`, `std.io.remove_file`, and the handle open/read/write/seek/close operations directly through compiler-owned Win32 calls.
