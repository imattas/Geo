...
- Array truncation and first/last pop are now native on both targets; finish indexed removal/insertion and generic copy/resize next so compiler-owned buffers can mutate without private helpers.
