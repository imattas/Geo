...
- Linux and Windows `create_dir_all` now create path prefixes natively with bounded input handling and existing-directory validation; implement recursive removal next.
