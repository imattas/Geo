...
- Expand the Windows COFF writer beyond the current object subset and make the PE64 path handle broader runtime imports, allocation-backed strings, and external symbols through compiled machine code.
