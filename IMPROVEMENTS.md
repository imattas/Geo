...
- Expand ELF64 object writing to cover control flow, comparisons, division/remainder, shifts, pointers, aggregate layout, data sections, and linkable runtime calls.
